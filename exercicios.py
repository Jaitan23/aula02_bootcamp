...
#     resultado = print("O resultado da soma é:", numero_01 + numero_02)
# except:
...
# resultado = Num ** 2
# print("o quadrado do número informado é:", resultado)
...
# num1 = float(input("Insira numero_01:"))
# num2 = float(input("Insira numero_02:"))
# resultado = num1 + num2
# print("A soma dos números é:", resultado)

# 7. Crie um programa que calcule a média de dois números flutuantes fornecidos pelo usuário.

# Num_1 = float(input("Insira o número_01:"))
# Num_2 = float(input("Insira o número_02:"))
